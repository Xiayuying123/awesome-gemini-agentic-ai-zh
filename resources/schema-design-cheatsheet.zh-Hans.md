...
- [Stage 5.2 — MCP 基础](../stages/05-gemini-skills-ecosystem.zh-Hans.md#52--mcpmodel-context-protocol-基础) — MCP server 的 tool schema（跟 function calling schema 结构几乎相同）
