...
| [Anthropic Academy](https://anthropic.skilljar.com/) ⭐⭐⭐⭐ | 🆓 | People building agents on the Claude / MCP stack | Antigravity CLI, Claude API, MCP, Agent Skills; 17 self-paced courses across 5 tracks | Free official certificate (issued via Skilljar, includes a quiz, email sign-up, LinkedIn-shareable). Caveat: vendor-specific (Claude/MCP) — a supplement to, not a replacement for, a framework-neutral foundation course |
