...
- [Stage 5.2 — MCP foundation](../stages/05-gemini-skills-ecosystem.en.md#52--mcp-model-context-protocol--foundation) — MCP server tool schemas (nearly identical structure to function-calling schema)
