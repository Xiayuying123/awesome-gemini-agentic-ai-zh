...
> 🔑 **Key terms**: see [`resources/glossary.en.md` 5](../../resources/glossary.en.md#5-claude-code-ecosystem) (GEMINI.md / slash command / SKILL.md / plugin / portable prompt)
...
- Write a practical `GEMINI.md` / `AGENTS.md` — the minimum practical shape is **(1) role** + **(2) project context** + **(3) forbidden actions** + **(4) test commands** + **(5) delivery format**. In practice, 30-50 lines can usually cover those 5 things; beyond 50 lines, split the file
...
1. [**Anthropic — GEMINI.md best practices**](https://docs.anthropic.com/en/docs/claude-code/memory) ⭐
...
3. [**Stage 5.1 — Antigravity CLI Basics**](../../stages/05-gemini-skills-ecosystem.en.md#51--claude-code-basics) — slash command details
...
### Exercise CLI-5: Write production GEMINI.md
Your GEMINI.md should at minimum contain:
...
Commit it to git. Next time a teammate clones the repo, their Antigravity CLI auto-loads your conventions.
...
3. Check against the style rules in GEMINI.md
...
> ⭐ **Advanced note: Antigravity CLI native multi-agent mechanisms** (read this one sentence for now; no need to expand it in A2): the manual sub-task splitting in CLI-7 can be automated with Antigravity CLI's **Subagent / Agent team / Background agent** mechanisms. The full explanation, exercises, and when-not-to-use guidance (team permissions, context isolation, and result-review flow all matter) are in **[Stage 5.5](../../stages/05-gemini-skills-ecosystem.en.md#55--subagents-claude-codes-native-multi-agent-mechanism--2025-new-feature)**.

### Exercise CLI-8: Portable prompt
Write a prompt that works in Antigravity CLI. **Run the same prompt in Codex / OpenCode / Gemini CLI** — what needs to change? Common discoveries:
...
official — Antigravity CLI memory / GEMINI.md authoring docs, including best practices.

#### [obra/superpowers](https://github.com/obra/superpowers) ⭐⭐⭐⭐
★ 178k+ — Not just a skill collection but also a production GEMINI.md template. Read the full `.claude/` structure.

#### [mattpocock/skills](https://github.com/mattpocock/skills) ⭐⭐⭐⭐
A practitioner's daily skill library. The `.claude/` structure is a great reference. **More skill examples in [Stage 5.3 — Skills](../../stages/05-gemini-skills-ecosystem.en.md#53--skills-claude-codes-behavior-layer--the-most-critical-layer-of-the-claude-code-ecosystem).**
...
Community-curated Antigravity CLI resources. Browse the slash command examples.
...
- [**yamadashy/repomix**](https://github.com/yamadashy/repomix) ⭐⭐⭐⭐⭐ ★ 24k+ — Packs your entire codebase into a single AI-friendly file (XML / Markdown / JSON) for Antigravity CLI / Codex code review / refactoring. Includes MCP server mode + tree-sitter compression (compression varies by language and file structure) + secretlint for secret filtering. **A must-have, daily-driver-grade tool for Track A.**

## ✅ Self-Check Before A3

Can you:
- [ ] Written at least 1 GEMINI.md for a production / work repo (not a demo repo)
...
If no → GEMINI.md only on demo repos is wasted; go write one for your real repo first.

## 💡 Common Pitfalls

- **GEMINI.md too long**: over 100 lines and the CLI auto-truncates / ignores the back half. Sweet spot: 30-60 lines.
...
- **"I already know all this, I don't need to write it"**: GEMINI.md is for future you (and new team members), not for current you.
