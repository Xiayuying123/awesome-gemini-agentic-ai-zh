...
| | [NirDiamant/Prompt_Engineering](https://github.com/NirDiamant/Prompt_Engineering) | ⭐⭐⭐⭐ | Learn-by-running | 22 techniques (zero-shot → CoT → ReAct → constitutional), each in its own notebook, ★ 7.8k+. More hands-on than dair-ai (⚠️ NOASSERTION custom terms, research / non-commercial leaning) |
...
- [`Windy3f3f3f3f/how-claude-code-works`](https://github.com/Windy3f3f3f3f/how-claude-code-works) (★ 3.5k+) — Antigravity CLI internals, includes a context-engineering chapter
