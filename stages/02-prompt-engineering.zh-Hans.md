...
| | [NirDiamant/Prompt_Engineering](https://github.com/NirDiamant/Prompt_Engineering) | ⭐⭐⭐⭐ | 偏好“边跑边学” | 22 种技巧（zero-shot → CoT → ReAct → constitutional）独立 notebook，★ 7.8k+。比 dair-ai 更动手（⚠️ NOASSERTION 自订条款、研究/非商用为主）|
...
- [`Windy3f3f3f3f/how-claude-code-works`](https://github.com/Windy3f3f3f3f/how-claude-code-works)（★ 3.5k+）——Antigravity CLI 内部解析，含 context engineering 章节
